...
export default function TermsConditionsSection() {
  return (
    <>
      <div className="mx-auto xl:max-w-[1440px] pb-[3em] xl:pb-[30px] privacy-section">
        <div className="w-full m-auto">
          <p className="">
            Please read these terms and conditions carefully before using Our
            Service.
          </p>
          <div className="mb-[3em]" id="terms-a">
            <p className="mb-[10px] !font-bold">
              Interpretation and Definitions
            </p>
          </div>
          <div className="mb-[3em]">
            <p className="mb-[10px] !font-bold">Interpretation</p>
            <p className="" id="terms-b">
          ...
          <div className="mb-[3em]">
            <p className="!font-bold mb-[10px]">Definitions</p>
            <p id="terms-c">For the purposes of these Terms and Conditions:</p>
          </div>
          <div className="mb-[3em]">
            <p className="mb-[10px] !font-bold">
            ...
            <ul className="list-disc space-y-[5px] pl-[20px] mb-[40px]">
              ...
              <li>
                <span className="font-bold">Website</span> refers to Welture
                Solution, accessible from welturesolution.com
              </li>
              <li id="terms-d">
          ...
          <div className="mb-[3em]">
            <p className="!font-bold mb-[10px]">Acknowledgment</p>
            <p className="mb-[20px]">
          ...
          <div className="mb-[3em]">
            <p className="mb-[10px] !font-bold">Links to Other Websites</p>
            <p className="mb-[20px]">
          ...
          <div className="mb-[3em]">
            <p className="mb-[10px] !font-bold">Termination</p>
            <p className="mb-[20px]">
          ...
          <div className="mb-[3em]">
            <p className="mb-[10px] !font-bold">Limitation of Liability</p>
            <p className="mb-[20px]">
          ...
          <div className="mb-[3em]">
            ...
            <p className="mb-[10px] !font-bold">Severability</p>
            <p id="terms-j">
          ...
          <div className="mb-[3em]">
            <p className="mb-[10px] !font-bold">Waiver</p>
            <p id="terms-k">
